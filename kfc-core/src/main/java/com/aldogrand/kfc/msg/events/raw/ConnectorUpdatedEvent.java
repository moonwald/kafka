...
/**
 * <p>
 * <b>Title</b> ConnectorCreatedEvent.java
 * </p>
 ...
 * @version 1.0
 */
@ContentType(EventContentType.CONNECTOR_UPDATED)
public class ConnectorUpdatedEvent extends KFCEvent {

	private Connector connectorData;

	public Connector getConnectorData() {
		return connectorData;
	}

	public void setConnectorData(Connector connectorData) {
