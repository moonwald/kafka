...
public class DefaultKeyGeneratorImplTest {
    ...
    public void keyGeneratorSettledBetsReceivedTest() throws ParseException, EvaluationException, NumberFormatException, ProducerException, RuntimeException {
    	String keyGenerated = "";
    	List <SettledBet> settleBetList = new ArrayList<SettledBet>();
    	SettledBet settleBet = new SettledBet(); 

        long diff = 0;
        long start = System.currentTimeMillis();
        for (int i = 0; i < 1; i++) {
        	settleBet.setEventId("12345");
        	settleBetList.add(settleBet);
        	settleBetReceived.setSettledBets(settleBetList);
    ...
    public void keyGeneratorConnectorUpdatedTest() throws RuntimeException {
        ...
        for (int i = 0; i < 1; i++) {
        	...
        	connector.setId(1L);
        	connectorUpdated.setConnectorData(connector);
    ...
    public void keyGeneratorPricesReceivedTest() throws RuntimeException {
        ...
        for (int i = 0; i < 1; i++) {
        	price.setEventId("12345");
        	priceList.add(price);
        	priceReceived.setPrices(priceList);
    ...
    public void keyGeneratorEventMapFoundTest() throws RuntimeException {
        com.aldogrand.sbpc.model.SourceEvent event;
        String keyGenerated = "";

        long diff = 0;
        long start = System.currentTimeMillis();
        for (int i = 0; i < 1; i++) {
        	event = new com.aldogrand.sbpc.model.SourceEvent();
        	event.setId(12345L);
        	eventMapFound.setIntegrationModuleId("1");
        	eventMapFound.setSourceEvent(event);
    ...
    public void keyGeneratorEventMapNewTest() throws RuntimeException {
        ...
        for (int i = 0; i < 1; i++) {
        	...
        	eventMapNew.setSourceEvent(event);
    ...
    public void keyGeneratorEventNotMappedTest() throws RuntimeException {
        ...
        for (int i = 0; i < 1; i++) {
        	...
        	eventNotMapped.setSourceEvent(event);
    ...
    public void keyGeneratorSourceEventCreatedTest() throws RuntimeException {
        ...
        for (int i = 0; i < 1; i++) {
        	...
        	event.setEventId(12345L);
        	sourceEventCreated.setIntegrationModuleId("1");
        	sourceEventCreated.setSourceEvent(event);
    ...
    public void keyGeneratorSourceEventUpdatedTest() throws RuntimeException {
        ...
        for (int i = 0; i < 1; i++) {
        	...
        	sourceEventUpdated.setSourceEvent(event);
    ...
    public void keyGeneratorMarketMapFoundTest() throws RuntimeException {
        com.aldogrand.sbpc.model.SourceMarket market;
        String keyGenerated = "";

        long diff = 0;
        long start = System.currentTimeMillis();
        for (int i = 0; i < 1; i++) {
        	market = new com.aldogrand.sbpc.model.SourceMarket();
        	market.setId(12345L);
        	marketMapFound.setIntegrationModuleId("1");
        	marketMapFound.setSourceMarket(market);
    ...
    public void keyGeneratorMarketMapNewTest() throws RuntimeException {
        ...
        for (int i = 0; i < 1; i++) {
        	market = new com.aldogrand.sbpc.model.SourceMarket();
        	market.setSourceEventId(12345L);
        	marketMapNew.setIntegrationModuleId("1");
        	marketMapNew.setSourceMarket(market);
    ...
    public void keyGeneratorMarketNotMappedTest() throws RuntimeException {
        ...
        long start = System.currentTimeMillis();
        for (int i = 0; i < 1; i++) {
        	market = new SourceMarket();
        	market.setSourceEventId(12345L);
        	marketNotMapped.setIntegrationModuleId("1");
        	marketNotMapped.setSourceMarket(market);
    ...
    public void keyGeneratorSourceMarketsReceivedTest() throws RuntimeException {
        ...
        market.setEventId("12345");
        marketList.add(market);
    	sourceMarketReceived.setMarkets(marketList);
    ...
    public void keyGeneratorSourceMarketCreatedTest() throws RuntimeException {
        ...
        for (int i = 0; i < 1; i++) {
        	...
        	sourceMarketCreated.setSourceMarket(market);
    ...
    public void keyGeneratorSourceMarketUpdatedTest() throws RuntimeException {
    	SourceMarket market;
    	com.aldogrand.sbpc.model.Market marketMapped = new com.aldogrand.sbpc.model.Market();
        String keyGenerated = "";
        ...
        for (int i = 0; i < 1; i++) {
        	market = new SourceMarket();
        	market.setSourceEventId(12345L);
        	marketMapped.setEventId(12345L);
        	sourceMarketUpdated.setIntegrationModuleId("1");
        	sourceMarketUpdated.setSourceMarket(market);
        	sourceMarketUpdated.setMarket(marketMapped);
    ...
    public void keyGeneratorRunnerMapFoundTest() throws RuntimeException {
        com.aldogrand.sbpc.model.SourceRunner runner;
        String keyGenerated = "";

        long diff = 0;
        long start = System.currentTimeMillis();
        for (int i = 0; i < 1; i++) {
        	runner = new com.aldogrand.sbpc.model.SourceRunner();
        	runner.setId(12345L);
        	runnerMapFound.setIntegrationModuleId("1");
        	runnerMapFound.setSourceRunner(runner);
    ...
    public void keyGeneratorRunnerMapNewTest() throws RuntimeException {
        ...
        for (int i = 0; i < 1; i++) {
        	runner = new com.aldogrand.sbpc.model.SourceRunner();
        	runner.setSourceEventId(12345L);
        	runnerMapNew.setIntegrationModuleId("1");
        	runnerMapNew.setSourceRunner(runner);
    ...
    public void keyGeneratorRunnerNotMappedTest() throws RuntimeException {
        ...
        long start = System.currentTimeMillis();
        for (int i = 0; i < 1; i++) {
        	sourceRunner = new SourceRunner();
        	sourceRunner.setSourceEventId(12345L);
        	runnerNotMapped.setIntegrationModuleId("1");
        	runnerNotMapped.setSourceRunner(sourceRunner);
    ...
    public void keyGeneratorSourceRunnerCreatedTest() throws RuntimeException {
        ...
        long start = System.currentTimeMillis();
        for (int i = 0; i < 1; i++) {
        	runner = new SourceRunner();
        	runner.setSourceMarketId(12345L);
        	runner.setSourceEventId(12345L);
        	sourceRunnerCreated.setIntegrationModuleId("1");
        	sourceRunnerCreated.setSourceRunner(runner);
    ...
    public void keyGeneratorSourceRunnerUpdatedTest() throws RuntimeException {
    	SourceRunner runner;
    	com.aldogrand.sbpc.model.Runner runnerMapped = new com.aldogrand.sbpc.model.Runner();
        String keyGenerated = "";
        ...
        for (int i = 0; i < 1; i++) {
        	...
        	runner.setSourceMarketId(12345L);
        	runner.setSourceEventId(12345L);
        	runnerMapped.setEventId(12345L);
        	sourceRunnerUpdated.setIntegrationModuleId("1");
        	sourceRunnerUpdated.setSourceRunner(runner);
        	sourceRunnerUpdated.setRunner(runnerMapped);
